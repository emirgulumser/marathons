...
function normalize(a) {
  ...
  return {
    ...
    elevLossM: a.elevationLoss ? Math.round(a.elevationLoss / 100) : null,
    avgHr: a.avgHr ?? null,
    maxHr: a.maxHr ?? null,
    ...
    avgCadence: a.avgRunCadence ?? a.averageRunningCadenceInStepsPerMinute ?? null,
    maxCadence: a.maxRunCadence ?? null,
    avgPower: a.avgPower ?? null,
    avgGct: a.avgGroundContactTime ?? a.groundContactTime ?? null,
    avgVerticalOsc: a.avgVerticalOscillation ?? a.verticalOscillation ?? null,
    avgStrideLength: a.avgStrideLength ?? a.strideLength ?? null,
    avgGctBalance: a.avgGroundContactBalance ?? a.groundContactBalanceLeft ?? null,
